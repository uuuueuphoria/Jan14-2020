...
},{}],"js/views/employee.js":[function(require,module,exports) {
"use strict";
...
function employeeView(employees) {
  ...
  var templateMarkup = employees.map(function (employee, index) {
    var template = "<figure>\n<img src=\"".concat(employee.avatar, "\" alt=\"\" width=\"140\" height=\"140\" loading=\"lazy\"> \n<figcaption>\n<ul>\n<li>").concat(employee.first_name, " ").concat(employee.last_name, "</li>\n<li>").concat(employee.email, "</li>\n</ul>\n</figcaption>\n</figure>");
    return template;
  });
...
},{}],"js/util/createElementFromTemplate.js":[function(require,module,exports) {
"use strict";
...
var _default = createElementFromTemplate;
exports.default = _default;
},{}],"js/util/addMarkupToPage.js":[function(require,module,exports) {
"use strict";
...
var _employee = _interopRequireDefault(require("./views/employee.js"));

var _createElementFromTemplate = _interopRequireDefault(require("./util/createElementFromTemplate"));

var _addMarkupToPage = _interopRequireDefault(require("./util/addMarkupToPage"));
